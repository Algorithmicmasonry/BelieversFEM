    ...
    return (
      <div>
        {error === "OAuthAccountNotLinked" && (
          <p style={{ color: "red" }}>
            This Google account is not linked to an existing user. Please sign
            up first or use a different login method.
          </p>
        )}
        {/* Your login form or buttons */}
      </div>
    );
  }
  return (
          ...
          <div className="">
            <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
              ...
              <PasswordInput
                ...
                forgotPasswordLink="/login/forgot-account"
              />
              ...
              <div>
                <SubmitButton
                  ...
                  loading={loading}
                  className="w-full cursor-pointer bg-primary text-primary-foreground font-semibold hover:bg-secondary hover:text-secondary-foreground"
                  loaderIcon={Loader2}
                  showIcon={false}
                />
              </div>
