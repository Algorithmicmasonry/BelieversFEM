    ...
    <div className="w-full py-5 lg:px-8 px-6">
      ...
      <div className="">
        <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            <SubmitButton
              ...
              loading={loading}
              className="w-full cursor-pointer bg-primary text-primary-foreground hover:bg-primary-foreground hover:text-primary text-md"
              loaderIcon={Loader2}
              showIcon={false}
            />
          </div>
        ...
        <p className="mt-6 text-left text-sm text-gray-500">
          Alrealy Registered ?{" "}
          <Link href="/login" className="font-semibold leading-6 text-primary underline">
            Login
          </Link>
        </p>
      </div>
