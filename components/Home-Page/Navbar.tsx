      ...
      <div className="hidden md:flex flex-1 justify-end gap-8">
        <div className="flex items-center gap-9">
          {navLinks.map((navLink, index) => (
            <Link
              className="text-[#171412] text-sm font-medium leading-normal hover:text-primary transition-colors cursor-pointer hover:bg-muted hover:rounded-2xl hover:p-4"
              href={navLink.href}
              key={index}
            >
             {navLink.name}
      ...
      <div className="md:hidden">
        <Sheet>
          <SheetTrigger asChild>
            <Button variant="ghost" size="icon" className="text-[#171412]">
          ...
          <SheetContent side="right" className="w-[300px] sm:w-[400px]">
            <div className="flex flex-col gap-6 mt-6">
              <div className="flex items-center gap-4 text-[#171412] pb-4 border-b border-[#f4f2f1]">
                <div className="size-4">
                  <svg
                    viewBox="0 0 48 48"
                    fill="none"
                ...
                <h2 className="text-[#171412] text-sm font-bold leading-tight tracking-[-0.015em]">
                  BIBLE FAITH EVANGELICAL MINISTRIES
                </h2>
              </div>
              ...
              <nav className="flex flex-col gap-4">
                <Link
                  className="text-[#171412] text-lg font-medium leading-normal py-2 hover:text-[#e8cbb4] transition-colors"
                  href="/about"
                >
                  About
                </Link>
              ...
              <div className="pt-4 border-t border-[#f4f2f1]">
                <Button className="w-full flex items-center justify-center rounded-xl h-12 px-4 bg-[#e8cbb4] text-[#171412] text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#d4b89a] transition-colors">
                  <span className="truncate">Join us</span>
                </Button>
              </div>
